...
void registerMain_box2d(Meta _d)
{
    _d._class(createMetaClass_B2AABB());
    _d._class(createMetaClass_B2BlockAllocator());
    _d._class(createMetaClass_B2Body());
    _d._class(createMetaClass_B2BodyDef());
    _d._class(createMetaClass_B2BroadPhase());
    _d._class(createMetaClass_B2CircleContact());
    _d._class(createMetaClass_B2CircleShape());
    _d._class(createMetaClass_B2ClipVertex());
    _d._class(createMetaClass_B2Color());
    _d._class(createMetaClass_B2Contact());
    _d._class(createMetaClass_B2ContactConstraint());
    _d._class(createMetaClass_B2ContactConstraintPoint());
    _d._class(createMetaClass_B2ContactEdge());
    _d._class(createMetaClass_B2ContactFilter());
    _d._class(createMetaClass_B2ContactImpulse());
    _d._class(createMetaClass_B2ContactListener());
    _d._class(createMetaClass_B2ContactManager());
    _d._class(createMetaClass_B2ContactRegister());
    _d._class(createMetaClass_B2ContactSolver());
    _d._class(createMetaClass_B2DebugDraw());
    _d._class(createMetaClass_B2DestructionListener());
    _d._class(createMetaClass_B2DistanceInput());
    _d._class(createMetaClass_B2DistanceJoint());
    _d._class(createMetaClass_B2DistanceJointDef());
    _d._class(createMetaClass_B2DistanceOutput());
    _d._class(createMetaClass_B2DistanceProxy());
    _d._class(createMetaClass_B2DynamicTree());
    _d._class(createMetaClass_B2DynamicTreeNode());
    _d._class(createMetaClass_B2Filter());
    _d._class(createMetaClass_B2Fixture());
    _d._class(createMetaClass_B2FixtureDef());
    _d._class(createMetaClass_B2FrictionJoint());
    _d._class(createMetaClass_B2FrictionJointDef());
    _d._class(createMetaClass_B2GearJoint());
    _d._class(createMetaClass_B2GearJointDef());
    _d._class(createMetaClass_B2Jacobian());
    _d._class(createMetaClass_B2Joint());
    _d._class(createMetaClass_B2JointDef());
    _d._class(createMetaClass_B2JointEdge());
    _d._class(createMetaClass_B2LineJoint());
    _d._class(createMetaClass_B2LineJointDef());
    _d._class(createMetaClass_B2Manifold());
    _d._class(createMetaClass_B2ManifoldPoint());
    _d._class(createMetaClass_B2MassData());
    _d._class(createMetaClass_B2Mat22());
    _d._class(createMetaClass_B2Mat33());
    _d._class(createMetaClass_B2MouseJoint());
    _d._class(createMetaClass_B2MouseJointDef());
    _d._class(createMetaClass_B2Pair());
    _d._class(createMetaClass_B2PolygonAndCircleContact());
    _d._class(createMetaClass_B2PolygonContact());
    _d._class(createMetaClass_B2PolygonShape());
    _d._class(createMetaClass_B2PrismaticJoint());
    _d._class(createMetaClass_B2PrismaticJointDef());
    _d._class(createMetaClass_B2PulleyJoint());
    _d._class(createMetaClass_B2PulleyJointDef());
    _d._class(createMetaClass_B2QueryCallback());
    _d._class(createMetaClass_B2RayCastCallback());
    _d._class(createMetaClass_B2RayCastInput());
    _d._class(createMetaClass_B2RayCastOutput());
    _d._class(createMetaClass_B2RevoluteJoint());
    _d._class(createMetaClass_B2RevoluteJointDef());
    _d._class(createMetaClass_B2Shape());
    _d._class(createMetaClass_B2SimplexCache());
    _d._class(createMetaClass_B2StackAllocator());
    _d._class(createMetaClass_B2StackEntry());
    _d._class(createMetaClass_B2Sweep());
    _d._class(createMetaClass_B2TOIInput());
    _d._class(createMetaClass_B2TOIOutput());
    _d._class(createMetaClass_B2TOISolver());
    _d._class(createMetaClass_B2TimeStep());
    _d._class(createMetaClass_B2Transform());
    _d._class(createMetaClass_B2Vec2());
    _d._class(createMetaClass_B2Vec3());
    _d._class(createMetaClass_B2Version());
    _d._class(createMetaClass_B2WeldJoint());
    _d._class(createMetaClass_B2WeldJointDef());
    _d._class(createMetaClass_B2World());
    _d._class(createMetaClass_B2WorldManifold());
    _d._class(createMetaClass_Features());
    _d._class(createMetaClass_Global_b2blockallocator());
    _d._class(createMetaClass_Global_b2body());
    _d._class(createMetaClass_Global_b2broadphase());
    _d._class(createMetaClass_Global_b2collision());
    _d._class(createMetaClass_Global_b2distance());
    _d._class(createMetaClass_Global_b2dynamictree());
    _d._class(createMetaClass_Global_b2joint());
    _d._class(createMetaClass_Global_b2math());
    _d._class(createMetaClass_Global_b2pulleyjoint());
    _d._class(createMetaClass_Global_b2settings());
    _d._class(createMetaClass_Global_b2stackallocator());
    _d._class(createMetaClass_Global_b2timeofimpact());
}
