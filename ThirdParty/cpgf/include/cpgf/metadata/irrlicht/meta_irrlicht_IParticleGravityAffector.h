...
#ifndef __META_IRRLICHT_IPARTICLEGRAVITYAFFECTOR_H
#define __META_IRRLICHT_IPARTICLEGRAVITYAFFECTOR_H
...
template <typename D>
void buildMetaClass_IParticleGravityAffector(const cpgf::GMetaDataConfigFlags & config, D _d)
{
