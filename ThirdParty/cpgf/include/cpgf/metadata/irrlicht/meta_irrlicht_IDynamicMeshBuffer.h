...
#ifndef __META_IRRLICHT_IDYNAMICMESHBUFFER_H
#define __META_IRRLICHT_IDYNAMICMESHBUFFER_H
...
template <typename D>
void buildMetaClass_IDynamicMeshBuffer(const cpgf::GMetaDataConfigFlags & config, D _d)
{
