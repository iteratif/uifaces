...
#ifndef __META_IRRLICHT_SSHAREDMESHBUFFER_H
#define __META_IRRLICHT_SSHAREDMESHBUFFER_H
...
template <typename D>
void buildMetaClass_SSharedMeshBuffer(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    _d.CPGF_MD_TEMPLATE _constructor<void * ()>();
    _d.CPGF_MD_TEMPLATE _constructor<void * (core::array< video::S3DVertex > *)>();
    ...
    _d.CPGF_MD_TEMPLATE _field("MappingHintVertex", &D::ClassType::MappingHintVertex);
    _d.CPGF_MD_TEMPLATE _field("MappingHintIndex", &D::ClassType::MappingHintIndex);
