...
#ifndef __META_IRRLICHT_IGUIFILEOPENDIALOG_H
#define __META_IRRLICHT_IGUIFILEOPENDIALOG_H
...
template <typename D>
void buildMetaClass_IGUIFileOpenDialog(const cpgf::GMetaDataConfigFlags & config, D _d)
{
