...
#ifndef __META_IRRLICHT_CMESHBUFFER_H
#define __META_IRRLICHT_CMESHBUFFER_H
...
void buildMetaClass_CMeshBuffer(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _field("MappingHint_Vertex", &D::ClassType::MappingHint_Vertex);
    _d.CPGF_MD_TEMPLATE _field("MappingHint_Index", &D::ClassType::MappingHint_Index);
