...
#ifndef __META_IRRLICHT_IWRITEFILE_H
#define __META_IRRLICHT_IWRITEFILE_H
...
template <typename D>
void buildMetaClass_Global_iwritefile(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_IWriteFile(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
